...
declare const VIRTUAL_ROUTER_BASE_PATH = "CLERK-ROUTER/VIRTUAL";
/**
 * Whether `to` addresses the in-memory component router rather than a real application route.
 */
declare const isVirtualRouterPath: (to: string) => boolean;
...
//#endregion
export { VIRTUAL_ROUTER_BASE_PATH, buildURL, createAllowedRedirectOrigins, getETLDPlusOneFromFrontendApi, getSearchParameterFromHash, hasBannedHrefProtocol, hasBannedProtocol, hasExternalAccountSignUpError, hasUrlInFragment, isAllowedRedirect, isDataUri, isDevAccountPortalOrigin, isDevOrStagingUrl, isProblematicUrl, isRedirectForFAPIInitiatedFlow, isValidUrl, isVirtualRouterPath, mergeFragmentIntoUrl, pathFromFullPath, relativeToAbsoluteUrl, requiresUserInput, sanitizeHref, stripOrigin, toURL, trimLeadingSlash, trimTrailingSlash };