...
/** @inline */
export type PasswordHasher = 'argon2i' | 'argon2id' | 'awscognito' | 'bcrypt' | 'bcrypt_sha256_django' | 'md5' | 'pbkdf2_sha256' | 'pbkdf2_sha256_django' | 'pbkdf2_sha1' | 'phpass' | 'scrypt_firebase' | 'scrypt_werkzeug' | 'sha256' | 'md5_phpass' | 'ldap_ssha';
/** @inline */
...
export declare class UserAPI extends AbstractAPI {
     ...
     * ```
     */
    removePassword(userId: string, params?: RemovePasswordParams): Promise<User>;
